...
# p.make_mutated_copies(.01,[0])
# p.make_mutated_copies(.01,[0])
# p.select_molecules([1,2,3])
# p.pe_sequencing(error_ratio=0.02)
# p.se_sequencing(coverage=25)
# p.write_reference("puzzle_F-seed1_ref.fasta")
# p.execute(prefix="puzzle_F-seed1",seed=1)

# p.make_mutated_copies(.01,[0])
# p.make_mutated_copies(.01,[0])
# p.make_mutated_copies(.01,[1,2])
# p.make_mutated_copies(.01,[1,2])
# p.select_molecules([3,4,5,6])
# p.pe_sequencing(error_ratio=0.02)
# p.se_sequencing(coverage=25)
# p.write_reference("puzzle_G-seed1_ref.fasta")
# p.execute(prefix="puzzle_G-seed1",seed=1)

# p.make_mutated_copies(.01,[0])
# p.make_mutated_copies(.01,[1])
# p.make_mutated_copies(.01,[2])
# p.pe_sequencing(error_ratio=0.02)
# p.se_sequencing(coverage=25)
# p.write_reference("puzzle_H-seed1_ref.fasta")
# p.execute(prefix="puzzle_H-seed1",seed=1)
